...
export function LightboxModal({ work, works, currentIndex, onClose, onPrevious, onNext }: LightboxModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 flex items-center justify-center" onClick={onClose}>
      {/* Content container */}
      <div className="relative z-10 flex flex-col lg:flex-row items-center gap-8 max-w-7xl mx-auto p-6 max-h-[90vh]" onClick={(e) => e.stopPropagation()}>
        ...
        {/* Metadata panel */}
        <div className={cn(
          "lg:w-96 bg-white rounded-xl shadow-2xl max-h-[70vh] overflow-y-auto transition-transform duration-300",
        ...
        <button
          ...
          className="lg:hidden fixed bottom-6 right-6 p-3 rounded-full bg-white shadow-lg text-gray-700"
        >
