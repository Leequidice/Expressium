...
export default function HomePage() {
  ...
  const handleWorkClick = (work: any) => {
    // This will be handled by the gallery page
          ...
          <div className="text-center space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl lg:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                A minimalist online showroom that serves as a curated gallery for displaying 
                creative works, community projects, and artworks. Experience art in a clean, 
                distraction-free environment where creativity takes center stage.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-light text-gray-900 mb-4">
              Why Choose Expressium?
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We've created a platform that prioritizes the art and artist, 
              providing a distraction-free environment for discovery and appreciation.
            </p>
          </div>
